    ...
    if (in_array($fileActualExt, $allwoed)) {
        if ($fileerror === 0) {
            if ($filesize > 10000000) {
                ...
                $addstaff = "INSERT INTO `building`(`building_name`, `buidling_description`, `building_rent`, `building_images`, `building_location`, `building_agent_id`) VALUES ('$catname','$description','$rent','$filenamenew','$location','$agent')";
