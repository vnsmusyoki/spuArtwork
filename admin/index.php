            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-8">
                    <h4 class="font-20 weight-500 mb-10 text-capitalize">
                        Welcome back Admin - <div class="weight-600 font-30 text-blue"><?php echo $globalmembername; ?>!
                        </div>
                    </h4>
                    <p class="font-18 max-width-600">You are in control of everything happening to the system, Create,
                        Edit
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <div class="widget-data">
                            <?php
                                ...
                                echo "<div class='h4 mb-0'>$bookingsplansrows</div>
                                <div class='weight-600 font-14'>All Agents</div>";
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <div class="widget-data">
                            <?php
                                ...
                                $bookingsplansrows = mysqli_num_rows($querybookingsplans);
                                echo "<div class='h4 mb-0'>$bookingsplansrows</div>
                                <div class='weight-600 font-14'>All Users</div>";
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <div class="widget-data">
                            <?php
                                ...
                                $bookingsplansrows = mysqli_num_rows($querybookingsplans);
                                echo "<div class='h4 mb-0'>$bookingsplansrows</div>
                                <div class='weight-600 font-14'>All Buildings</div>";
                            ...
                            <?php
                                ...
                                if($bookingsplansrows > 1){
                                    ...
                                    while($fetch = mysqli_fetch_assoc($querybookingsplans)){
                                        $total = $total + $fetch['payment_amount'];
                                    }
                                }
                                echo "<div class='h4 mb-0'>Ksh. $total</div>
                                <div class='weight-600 font-14'>All Agents</div>";
