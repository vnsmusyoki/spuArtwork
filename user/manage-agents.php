...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>Manage Admins Dashboard</title>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">All Agents</h4>
                    </div>
                    <div class="pb-20">
                        <table class="table hover multiple-select-row data-table-export nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>$username</td>
                                    <td>
                                    <a href='edit-agent.php?agent=$aid' class='btn btn-sm btn-warning'>Edit</a>
                                    <a href='delete-agent.php?agent=$aid' class='btn btn-sm btn-danger'>Delete</a>
                                    </td>
                                </tr>";
                                    }
                                }
